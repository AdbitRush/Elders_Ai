...
const GameText = (() => {
  const GT = {
    es: {
      ...
      "Play on another device": "Jugar en otro dispositivo",
      "Your progress is saved on this device. To carry on from a phone or tablet, get a code here and type it there.": "Tu progreso se guarda en este dispositivo. Para seguir en un móvil o tableta, pide un código aquí y escríbelo allí.",
      "Show my code": "Ver mi código",
      "Already have a code from your other device?": "¿Ya tienes un código de tu otro dispositivo?",
      "6 characters": "6 caracteres",
      "Connect": "Conectar",
      "Close": "Cerrar",
      "One moment…": "Un momento…",
      "Could not get a code. Check the internet connection and try again.": "No se pudo obtener un código. Comprueba la conexión e inténtalo de nuevo.",
      "Type this on the other device. It works for 30 minutes.": "Escríbelo en el otro dispositivo. Es válido 30 minutos.",
      "Connected. Your progress is now shared between the devices.": "Conectado. Tu progreso ya se comparte entre los dispositivos.",
      "A code is exactly 6 characters.": "El código tiene exactamente 6 caracteres.",
      "No connection. Try again in a moment.": "Sin conexión. Inténtalo dentro de un momento.",
      "That code is wrong or has expired.": "Ese código es incorrecto o ha caducado.",
    },
    fr: {
      ...
      "Play on another device": "Jouer sur un autre appareil",
      "Your progress is saved on this device. To carry on from a phone or tablet, get a code here and type it there.": "Votre progression est enregistrée sur cet appareil. Pour continuer sur un téléphone ou une tablette, obtenez un code ici et saisissez-le là-bas.",
      "Show my code": "Afficher mon code",
      "Already have a code from your other device?": "Vous avez déjà un code de votre autre appareil ?",
      "6 characters": "6 caractères",
      "Connect": "Connecter",
      "Close": "Fermer",
      "One moment…": "Un instant…",
      "Could not get a code. Check the internet connection and try again.": "Impossible d'obtenir un code. Vérifiez la connexion et réessayez.",
      "Type this on the other device. It works for 30 minutes.": "Saisissez-le sur l'autre appareil. Valable 30 minutes.",
      "Connected. Your progress is now shared between the devices.": "Connecté. Votre progression est désormais partagée entre les appareils.",
      "A code is exactly 6 characters.": "Un code comporte exactement 6 caractères.",
      "No connection. Try again in a moment.": "Pas de connexion. Réessayez dans un instant.",
      "That code is wrong or has expired.": "Ce code est incorrect ou a expiré.",
    },
    de: {
      ...
      "Play on another device": "Auf einem anderen Gerät spielen",
      "Your progress is saved on this device. To carry on from a phone or tablet, get a code here and type it there.": "Ihr Fortschritt ist auf diesem Gerät gespeichert. Um auf Handy oder Tablet weiterzumachen, holen Sie hier einen Code und geben ihn dort ein.",
      "Show my code": "Meinen Code anzeigen",
      "Already have a code from your other device?": "Haben Sie schon einen Code vom anderen Gerät?",
      "6 characters": "6 Zeichen",
      "Connect": "Verbinden",
      "Close": "Schließen",
      "One moment…": "Einen Moment…",
      "Could not get a code. Check the internet connection and try again.": "Code konnte nicht geholt werden. Prüfen Sie die Internetverbindung und versuchen Sie es erneut.",
      "Type this on the other device. It works for 30 minutes.": "Geben Sie ihn auf dem anderen Gerät ein. Gültig für 30 Minuten.",
      "Connected. Your progress is now shared between the devices.": "Verbunden. Ihr Fortschritt wird jetzt zwischen den Geräten geteilt.",
      "A code is exactly 6 characters.": "Ein Code hat genau 6 Zeichen.",
      "No connection. Try again in a moment.": "Keine Verbindung. Versuchen Sie es gleich noch einmal.",
      "That code is wrong or has expired.": "Dieser Code ist falsch oder abgelaufen.",
    },
    el: {
      ...
      "Play on another device": "Παίξτε σε άλλη συσκευή",
      "Your progress is saved on this device. To carry on from a phone or tablet, get a code here and type it there.": "Η πρόοδός σας αποθηκεύεται σε αυτή τη συσκευή. Για να συνεχίσετε από κινητό ή tablet, πάρτε έναν κωδικό εδώ και πληκτρολογήστε τον εκεί.",
      "Show my code": "Δείξε τον κωδικό μου",
      "Already have a code from your other device?": "Έχετε ήδη κωδικό από την άλλη συσκευή;",
      "6 characters": "6 χαρακτήρες",
      "Connect": "Σύνδεση",
      "Close": "Κλείσιμο",
      "One moment…": "Μια στιγμή…",
      "Could not get a code. Check the internet connection and try again.": "Δεν ήταν δυνατή η λήψη κωδικού. Ελέγξτε τη σύνδεση και δοκιμάστε ξανά.",
      "Type this on the other device. It works for 30 minutes.": "Πληκτρολογήστε τον στην άλλη συσκευή. Ισχύει για 30 λεπτά.",
      "Connected. Your progress is now shared between the devices.": "Συνδέθηκε. Η πρόοδός σας μοιράζεται τώρα ανάμεσα στις συσκευές.",
      "A code is exactly 6 characters.": "Ο κωδικός έχει ακριβώς 6 χαρακτήρες.",
      "No connection. Try again in a moment.": "Χωρίς σύνδεση. Δοκιμάστε ξανά σε λίγο.",
      "That code is wrong or has expired.": "Ο κωδικός είναι λάθος ή έχει λήξει.",
    },
  };
