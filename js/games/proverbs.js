...
function _provNext(c) {
    ...
    c.innerHTML = `<div class="max-w-xl w-full text-center">
        <div class="flex justify-between text-sm font-bold text-gray-400 mb-4"><span>${gt('Proverb', 'פתגם')} ${gs.idx+1}/${gs.perLevel}</span><span class="text-green-600">&#10003; ${gs.score}</span></div>
