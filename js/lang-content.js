...
(function () {
  ...
  const UI = {
    es: {
      ...
      game_blocks_title:"Blocks", game_blocks_desc:"Apila las piezas que caen para completar líneas.",
      ...
      inst_blocks:"Mover: ← → | Girar: ↑ | Bajar: ↓ | Táctil: desliza o usa los botones",
    ...
    fr: {
      ...
      game_blocks_title:"Blocks", game_blocks_desc:"Empilez les pièces qui tombent pour compléter des lignes.",
      ...
      inst_blocks:"Déplacer : ← → | Tourner : ↑ | Descendre : ↓ | Tactile : glissez ou touchez les boutons",
    ...
    de: {
      ...
      game_blocks_title:"Blocks", game_blocks_desc:"Stapeln Sie die fallenden Formen zu vollen Reihen.",
      ...
      inst_blocks:"Bewegen: ← → | Drehen: ↑ | Fallen: ↓ | Touch: wischen oder Tasten tippen",
    ...
    el: {
      ...
      game_blocks_title:"Τέτρις", game_blocks_desc:"Στοιβάξτε τα σχήματα που πέφτουν για να γεμίσετε σειρές.",
      ...
      inst_blocks:"Κίνηση: ← → | Περιστροφή: ↑ | Πτώση: ↓ | Αφή: σύρετε ή πατήστε τα κουμπιά",
