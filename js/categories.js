...
const Categories = (() => {
  ...
  const WHY = {
    en: {
      ...
      simon:'Stretches how long a sequence you can hold and repeat.',
      ...
      tetris:'Rotating shapes to fit is mental rotation plus planning ahead.',
    ...
    he: {
      ...
      simon:'מותח את אורך הרצף שאפשר לזכור ולחזור עליו.',
      ...
      tetris:'סיבוב צורות כדי שיתאימו הוא סיבוב מנטלי ותכנון קדימה.',
    ...
    es: {
      ...
      simon:'Amplía la longitud de secuencia que puedes retener y repetir.',
      ...
      tetris:'Girar piezas para encajar es rotación mental y planificación.',
    ...
    fr: {
      ...
      simon:'Allonge la séquence que vous pouvez retenir et répéter.',
      ...
      tetris:'Faire pivoter les pièces : rotation mentale et anticipation.',
    ...
    de: {
      ...
      simon:'Erweitert, wie lange Folgen Sie behalten und wiederholen können.',
      ...
      tetris:'Formen zu drehen ist mentale Rotation und Vorausplanung.',
    ...
    el: {
      ...
      simon:'Επεκτείνει πόσο μεγάλη ακολουθία μπορείτε να συγκρατήσετε.',
      ...
      tetris:'Η περιστροφή σχημάτων είναι νοερή περιστροφή και σχεδιασμός.',
